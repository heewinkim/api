...
class IMDB(object):
    def __init__(self, name, image_set, root_path, dataset_path, mode='train'):
        self.name = name + '_' + image_set # wider_train
        self.image_set = image_set # train_12
        self.root_path = root_path # data
        self.data_path = dataset_path # data/wider
    ...
    def load_image_set_index(self):
        ...
        """
        image_set_index_file = os.path.join(self.data_path, 'train', self.image_set + '.txt')
    ...
    def load_annotations(self):
        ...
        imdb: dict
            image database with annotations
        """
        annotation_file = os.path.join(self.data_path, 'train', self.image_set + '.txt')
